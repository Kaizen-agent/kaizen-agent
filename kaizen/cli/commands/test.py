    ...
    try:
        ...
        if failed_tests:
            ...
            if auto_fix:
                ...
                if file_path:
                    ...
                    test_attempts = AutoFix(config_path).fix_code(str(resolved_file_path), failed_tests, max_retries=max_retries, create_pr=create_pr, base_branch=base_branch)
                    if create_pr:
        ...
        with open(result_file, 'w') as f:
            ...
            if failed_tests:
                ...
                if auto_fix and 'test_attempts' in locals():
                    f.write("\nAuto-fix Attempts:\n")
                    f.write("=" * 50 + "\n\n")
