...
class EmailAgent:
    """
    A class to interact with the Google Gemini API for improving email drafts.
    """
    ...
    def improve_email(self, draft: str) -> str:
        ...
        """
        # Add safety instructions to the prompt and ensure only the improved email is returned
        prompt = f"""You are an expert email assistant. Your task is to improve email drafts.

        Instructions:
        - Make the email more professional, clear, and effective.
        - Maintain the original intent and key information of the draft.
        - Focus on professional tone, concise communication, and proper email etiquette.
        - Provide ONLY the improved email draft.
        - Do NOT include any introductory phrases, concluding remarks, explanations, multiple options, or any text other than the improved email itself.
